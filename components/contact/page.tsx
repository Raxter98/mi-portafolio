    ...
    <section className="py-12 px-4 md:py-24 bg-background text-black dark:text-white" data-aos="fade-left">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight mb-4 text-black dark:text-white"> <span className="bg-red-500 p-2">{t.contact.title}</span></h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 border-b-red-500 border-b-2">{t.contact.infoTitle}</h3>
