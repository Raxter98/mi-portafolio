    ...
    <div className="w-32 h-32 md:w-36 md:h-36 md:mx-10">
      <div  className=" w-32 h-32 md:w-32 md:h-32 group relative block bg-black">
        <img
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 absolute-center inset-0 h-24 w-24 object-cover opacity-75 transition-opacity group-hover:opacity-50"
        />
