...
const AboutMe = () => {
  ...
  return (
    <div  data-aos="fade-left" className=" overflow-x-hidden md:w-full md:overflow-hidden mt-14 md:mt-0 ">
      <Ball />
      ...
      <section className=" md:flex   w-full  justify-center">
        ...
        <div className="md:w-[700px] md:mt-10  flex flex-col">
          <p className="text-xl z-10 font-[family-name:var(--font-geist-sans)]  md:mr-6">
           ...
           <br />
           <br />
           <span className="md:text-2xl">Higher Level Technician in Computer Science </span>
           <br />
           <span className="md:text-xl"> Higher Institute of Communication Arts and Sciences </span>
           <br />
           <span>2021-2023 Santiago, Chile</span>
           <br />
           <br />
          <span className="md:text-2xl">Bachelor of Multimedia Computing </span>
           <br />
           <span className="md:text-xl"> University of Arts, Sciences and Communications</span>
           <br />
          ...
          <a href="/cv.pdf" download="cv.pdf"><button className="bg-red-500 opacity-45 p-3 mt-4 rounded-md  hover:opacity-100 transition ease-in-out delay-150 " > Download CV ↴ </button> </a>
          </div>
